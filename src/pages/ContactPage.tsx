      ...
      <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
        ...
        <div className="container-px relative z-10 text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-600">
            We’d love to hear from you. Reach out to us for any queries, custom packages, or just to say hello.
          </p>
        </div>
      </section>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="name" className="text-sm font-medium theme-text-primary">Full Name *</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                    ...
                    className={`w-full px-4 py-3 rounded-xl border bg-white focus:outline-none focus:ring-2 focus:ring-[rgb(var(--accent-color))/50] transition ${
                      errors.name ? "border-red-500" : "border-gray-200 focus:border-[rgb(var(--accent-color))]"
                    }`}
                ...
                {/* Email Address */}
                <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-medium theme-text-primary">Email Address *</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-xl border bg-white focus:outline-none focus:ring-2 focus:ring-[rgb(var(--accent-color))/50] transition ${
                      errors.email ? "border-red-500" : "border-gray-200 focus:border-[rgb(var(--accent-color))]"
                    }`}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {/* Phone Number */}
                <div className="space-y-2">
                  <label htmlFor="phone" className="text-sm font-medium theme-text-primary">Phone Number (Optional)</label>
                  <input
                    type="tel"
                    id="phone"
                    name="phone"
                ...
                {/* Subject */}
                <div className="space-y-2">
                  <label htmlFor="subject" className="text-sm font-medium theme-text-primary">Subject *</label>
                  <input
                    type="text"
                    id="subject"
                    name="subject"
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-xl border bg-white focus:outline-none focus:ring-2 focus:ring-[rgb(var(--accent-color))/50] transition ${
                      errors.subject ? "border-red-500" : "border-gray-200 focus:border-[rgb(var(--accent-color))]"
                    }`}
              ...
              {/* Message */}
              <div className="space-y-2">
                <label htmlFor="message" className="text-sm font-medium theme-text-primary">Message *</label>
                <textarea
                  id="message"
                  name="message"
                  rows={5}
                  ...
                  className={`w-full px-4 py-3 rounded-xl border bg-white focus:outline-none focus:ring-2 focus:ring-[rgb(var(--accent-color))/50] transition resize-none ${
                    errors.message ? "border-red-500" : "border-gray-200 focus:border-[rgb(var(--accent-color))]"
                  }`}
            ...
            <div className="bg-[rgb(var(--primary-color))] text-white rounded-3xl p-8 sm:p-10 shadow-xl h-full flex flex-col justify-center">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-medium text-white/80 mb-1 text-sm">Email Address</h4>
                    <a href="mailto:websitemedjourney@gmail.com" className="text-lg hover:text-[rgb(var(--accent-color))] transition-colors break-all">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-medium text-white/80 mb-1 text-sm">Phone Number</h4>
                    <a href="tel:+911234567890" className="text-lg hover:text-[rgb(var(--accent-color))] transition-colors">
                      +91 123 456 7890
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-medium text-white/80 mb-1 text-sm">Office Address</h4>
