  ...
  return (
    <section className="relative min-h-[100svh] flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgb(var(--primary-color)) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="container-px relative z-10 text-white py-28">
        <div className="max-w-3xl fade-in">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              href="#video"
              className="btn-outline-accent text-base !text-white !border-white/70 hover:!bg-white/10"
            >
              Watch our story
            </a>
          </div>
      ...
      <a
        href="#packages"
        className="absolute bottom-6 left-1/2 -translate-x-1/2 text-white/70 text-xs animate-float"
        aria-label="Scroll"
      >
        Scroll to explore ↓
      </a>
